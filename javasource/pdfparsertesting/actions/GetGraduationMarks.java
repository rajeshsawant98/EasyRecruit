 ...
 */
public class GetGraduationMarks extends CustomJavaAction<java.lang.String>
{
	private IMendixObject __inputFile;
	private system.proxies.FileDocument inputFile;

	public GetGraduationMarks(IContext context, IMendixObject inputFile)
	{
		super(context);
	...
	public java.lang.String executeAction() throws Exception
	{
		...
		if (inputFile != null && inputFile.getHasContents(context)) {
			...
			String regex="(?s)Graduation\\sDetails(.*)Technical";
			 Matcher m = Pattern.compile(regex).matcher(content);
		     String obj="" ;
		     String objective="Graduation Details";
		     String blank="";
		      while (m.find()) 
		      { 
		          obj=obj+(m.group());
		    ...
		    String[] n=obj.split("Year");
		     obj=n[0];
		     String[] parts = obj.split(":");
			 String lastWord = parts[parts.length - 1];
			 String PercentageSign = "%";
			 lastWord= lastWord.replace(PercentageSign, blank);
			 String lastword = lastWord.replaceAll("\\s", "");
		     return lastword;
		}

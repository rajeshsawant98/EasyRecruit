 ...
 */
public class Get10thMarks extends CustomJavaAction<java.lang.String>
{
	private IMendixObject __inputFile;
	private system.proxies.FileDocument inputFile;

	public Get10thMarks(IContext context, IMendixObject inputFile)
	{
		super(context);
	...
	public java.lang.String executeAction() throws Exception
	{
		...
		if (inputFile != null && inputFile.getHasContents(context)) {
			...
			String regex="(?s)10th\\s(.*)Technical";
			 Matcher m = Pattern.compile(regex).matcher(content);
		     String obj="" ;
		     String objective="10th";
		     String blank="";
		      while (m.find()) 
		      { 
		          obj=obj+(m.group());

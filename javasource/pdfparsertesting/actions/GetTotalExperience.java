 ...
 */
public class GetTotalExperience extends CustomJavaAction<java.lang.String>
{
	private IMendixObject __inputFile;
	private system.proxies.FileDocument inputFile;

	public GetTotalExperience(IContext context, IMendixObject inputFile)
	{
		super(context);
	...
	public java.lang.String executeAction() throws Exception
	{
		...
		if (inputFile != null && inputFile.getHasContents(context)) {
		    ...
		    String[] n=obj.split("Technologies");
		   	    
		     obj=n[0];
		     String objective1="No. of Years:";

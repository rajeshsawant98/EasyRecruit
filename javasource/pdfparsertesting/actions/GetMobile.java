...
/**
 * Retrieves the content of a PDF file Extracts Mobile Numbers  and returns them as a string.
 */
public class GetMobile extends CustomJavaAction<java.lang.String>
{
	private IMendixObject __inputFile;
	private system.proxies.FileDocument inputFile;

	public GetMobile(IContext context, IMendixObject inputFile)
	{
		super(context);
	...
	public java.lang.String executeAction() throws Exception
	{
		...
		if (inputFile != null && inputFile.getHasContents(context)) {
			...
			Matcher m = Pattern.compile("(0/91)?[7-9][0-9]{9}").matcher(content);
		     String mobile="" ;
		      while (m.find()) 
		      { 
		          mobile=mobile+(m.group());
		      }
		      return mobile;
		}

 ...
 */
public class GetObjective extends CustomJavaAction<java.lang.String>
{
	private IMendixObject __inputFile;
	private system.proxies.FileDocument inputFile;

	public GetObjective(IContext context, IMendixObject inputFile)
	{
		super(context);

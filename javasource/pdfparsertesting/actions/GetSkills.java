 ...
 */
public class GetSkills extends CustomJavaAction<java.lang.String>
{
	private IMendixObject __inputFile;
	private system.proxies.FileDocument inputFile;

	public GetSkills(IContext context, IMendixObject inputFile)
	{
		super(context);
	...
	public java.lang.String executeAction() throws Exception
	{
		...
		if (inputFile != null && inputFile.getHasContents(context)) {
			...
			String regex="(?s)Technical\\sSkills:(.*)Training\\s&\\sCertification:";
			 Matcher m = Pattern.compile(regex).matcher(content);
		     String obj="" ;
		     String objective="Technical Skills:";
		     String blank="";
		      while (m.find()) 
		      { 
		          obj=obj+(m.group());
		    ...
		    String objective1="Training & Certification:";

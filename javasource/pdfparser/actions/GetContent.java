 ...
 */
public class GetContent extends CustomJavaAction<java.lang.String>
{
	private IMendixObject __inputFile;
	private system.proxies.FileDocument inputFile;

	public GetContent(IContext context, IMendixObject inputFile)
	{
		super(context);
	...
	public java.lang.String executeAction() throws Exception
	{
		...
		if (inputFile != null && inputFile.getHasContents(context)) {
			...
			return pdfParser.getContent(__inputFile, context);
		}

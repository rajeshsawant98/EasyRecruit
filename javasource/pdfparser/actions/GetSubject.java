...
/**
 * Returns the subject of the PDF document as a string.
 */
public class GetSubject extends CustomJavaAction<java.lang.String>
{
	private IMendixObject __inputFile;
	private system.proxies.FileDocument inputFile;

	public GetSubject(IContext context, IMendixObject inputFile)
	{
		super(context);
	...
	public java.lang.String executeAction() throws Exception
	{
		...
		if (inputFile != null && inputFile.getHasContents(context)) {
			...
			return pdfParser.getSubject(__inputFile, context);
		}

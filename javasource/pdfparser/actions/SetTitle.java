...
/**
 * Sets the title of a PDF document. Returns true if successfull.
 */
public class SetTitle extends CustomJavaAction<java.lang.Boolean>
{
	private IMendixObject __inputFile;
	private system.proxies.FileDocument inputFile;
	private java.lang.String title;

	public SetTitle(IContext context, IMendixObject inputFile, java.lang.String title)
	{
		super(context);
	...
	public java.lang.Boolean executeAction() throws Exception
	{
		...
		if (inputFile != null && inputFile.getHasContents(context)) {
			...
			pdfParser.setTitle(inputFile, context, title);
			return true;
		}

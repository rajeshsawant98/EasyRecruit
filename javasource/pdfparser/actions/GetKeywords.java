...
/**
 * Retrieves the keywords of a PDF file and returns it as a string.
 */
public class GetKeywords extends CustomJavaAction<java.lang.String>
{
	private IMendixObject __inputFile;
	private system.proxies.FileDocument inputFile;

	public GetKeywords(IContext context, IMendixObject inputFile)
	{
		super(context);
	...
	public java.lang.String executeAction() throws Exception
	{
		...
		if (inputFile != null && inputFile.getHasContents(context)) {
			...
			return pdfParser.getKeywords(__inputFile, context);
		}

...
{	
	...
	private boolean shouldLocalizeDate;
	...
	public boolean isShouldLocalizeDate() {
		return shouldLocalizeDate;
	}

	public void setShouldLocalizeDate(boolean shouldLocalizeDate) {
		this.shouldLocalizeDate = shouldLocalizeDate;
	}
}
